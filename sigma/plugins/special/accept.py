...
async def accept(ev, message, args):
    ...
    if message.content == '>>accept':
        ...
        embed = discord.Embed(title='ℹ ' + message.author.name + ' has accepted the terms on WKCD.', color=0x0099FF)
