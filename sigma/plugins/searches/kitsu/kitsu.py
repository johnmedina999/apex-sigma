...
async def kitsu(cmd, message, args):
    ...
    try: rating = attr['averageRating'][:5]
    except: rating = 'None'
    ...
    embed.set_author(name='Kitsu.io', icon_url='https://avatars3.githubusercontent.com/u/7648832?v=3&s=200', url=f'https://kitsu.io/anime/{slug}')
