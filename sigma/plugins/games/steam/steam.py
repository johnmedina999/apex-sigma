...
async def steam(cmd, message, args):
    ...
    with Image.open(BytesIO(avatar_raw)) as avatar:
        ...
        if onlinenow == 0:   imgdraw.text((2, 165), '*', (102, 102, 153), font=font)
        elif onlinenow == 1: imgdraw.text((2, 165), '*', (26, 188, 156), font=font)
        elif onlinenow == 2: imgdraw.text((2, 165), '*', (255, 51, 0), font=font)
        elif onlinenow == 3: imgdraw.text((2, 165), '*', (255, 153, 0), font=font)
        else:                imgdraw.text((2, 165), '*', (102, 102, 153), font=font)
