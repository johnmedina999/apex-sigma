...
async def wfwiki(cmd, message, args):
    ...
    async with aiohttp.ClientSession() as session:
        async with session.get(wiki_search_url) as data:
            ...
            try: article_id = search_json['items'][0]['id']
            except:
        ...
        embed.set_author(name='Warframe Wikia', icon_url=icon_url, url='http://fc08.deviantart.net/fs70/f/2013/362/8/b/warframe_icon__alternative__by_bokuwatensai-d6zs6fz.png')
        await message.channel.send(None, embed=embed)
